...
export const ROUTES: Route[] = [
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/prompt-engineering",
    icon: Sparkle,
    projectRbacScopes: ["prompts:read"],
    productModule: "prompt-management",
    group: RouteGroup.PromptManagement,
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/prompt-variants",
    icon: Lightbulb,
    projectRbacScopes: ["prompts:read"],
    productModule: "prompt-management",
    group: RouteGroup.PromptManagement,
  ...
  {
    title: "Prompt Store",
    pathname: "/project/[projectId]/prompt-store",
    icon: Database,
    projectRbacScopes: ["prompts:read"],
    productModule: "prompt-management",
    group: RouteGroup.PromptManagement,
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/cicd-artifacts",
    icon: Settings,
    projectRbacScopes: ["prompts:read"],
    productModule: "prompt-management",
    group: RouteGroup.PromptManagement,
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/prompts/scoring",
    icon: SquarePercent,
    projectRbacScopes: ["prompts:read"],
    productModule: "prompt-management",
    group: RouteGroup.PromptManagement,
